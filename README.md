...
| C\#                     | Desktop application tools to interface with metrology equipment and production data to aid in research, development, and production (Imetrum). |
...
| Databases               | Using PostgreSQL and Neo4j.                                                                                                                                                                                                                                                                                                                                                                         |
...
| Data Analysis           | Data analysis throughout university labs.                                                                                                                                                                                                                                                                                                                                                    |
